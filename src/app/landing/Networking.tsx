            ...
            <div
                ...
                <div className="flex-col leading-loose">
                    <p>O Smart City Expo Curitiba é o principal evento de cidades inteligentes do Brasil.
                        Com o tema {"\""}Reinventando cidades para todos{"\""}, a quinta edição acontecerá nos dias 20,
                        21 e 22 de março de 2024 no Centro de Eventos Positivo, no Parque Barigui.
